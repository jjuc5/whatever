...
<!-- nav drop down menus -->
			...
			<div class="col-xs-6">
			<!-- PAY TYPE Textbox name: pay_type -->
				<label for="pay_type"></label>Type of payment:</br>
				<div class="form-group">
					<label for="pay_type"></label> <select class="form-control" id="pay_type">
			...
			<!-- ACCOUNT NAME dropdown name: account_name -->
				<label for="account_name"></label>Choose an account to pay from:</br>
				<div class="form-group">
				...
				<div class="col-xs-8">
				<!-- PAYEE NAME Textbox name: payee_name -->
					<label for="payee_name">Payee Name:</label> <input class="form-control"	id="payee_name" type="text"> </br> </br>
				</div>
				<!-- ACCOUNT NUMBER Textbox name: payee_name -->
				<div class="col-xs-8">
					<label for="account_id">Account Number:</label> 
					<input class="form-control" id="account_id" type="text"> </br> </br>
				</div>
				<!-- PAYEE NAME Textbox name: payee_name -->
				<div class="col-xs-8">
					<label for="bill_amount">Amount:</label> <input class="form-control"
						id="bill_amount" type="text"> </br> </br>
